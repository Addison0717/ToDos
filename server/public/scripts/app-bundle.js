...
define('modules/list',['exports', 'aurelia-framework', '../resources/data/todos', 'aurelia-router', 'aurelia-auth'], function (exports, _aureliaFramework, _todos, _aureliaRouter, _aureliaAuth) {
    ...
    var List = exports.List = (_dec = (0, _aureliaFramework.inject)(_todos.ToDos, _aureliaRouter.Router, _aureliaAuth.AuthService), _dec(_class = function () {
        function List(todos, router, auth) {
...
define('text!modules/home.html', ['module'], function(module) { module.exports = "<template><div class=\"card-body\">    <div class=\"container\">    <compose show.bind=\"showLogin\" view=\"./components/login.html\"></compose>    <compose show.bind=\"!showLogin\" view=\"./components/register.html\"></compose></div></div></template>"; });
